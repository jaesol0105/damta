...
mixin _$PostEntity {
 ...
 String? get pId; String get pTitle; String get pContent; String get pWriter; DateTime get pCreatedAt; List<String>? get emojis; int? get view; List<CommentEntity>? get comments;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PostEntity&&(identical(other.pId, pId) || other.pId == pId)&&(identical(other.pTitle, pTitle) || other.pTitle == pTitle)&&(identical(other.pContent, pContent) || other.pContent == pContent)&&(identical(other.pWriter, pWriter) || other.pWriter == pWriter)&&(identical(other.pCreatedAt, pCreatedAt) || other.pCreatedAt == pCreatedAt)&&const DeepCollectionEquality().equals(other.emojis, emojis)&&(identical(other.view, view) || other.view == view)&&const DeepCollectionEquality().equals(other.comments, comments));
}


@override
int get hashCode => Object.hash(runtimeType,pId,pTitle,pContent,pWriter,pCreatedAt,const DeepCollectionEquality().hash(emojis),view,const DeepCollectionEquality().hash(comments));

@override
String toString() {
  return 'PostEntity(pId: $pId, pTitle: $pTitle, pContent: $pContent, pWriter: $pWriter, pCreatedAt: $pCreatedAt, emojis: $emojis, view: $view, comments: $comments)';
}
...
@useResult
$Res call({
 String? pId, String pTitle, String pContent, String pWriter, DateTime pCreatedAt, List<String>? emojis, int? view, List<CommentEntity>? comments
});
...
/// Create a copy of PostEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? pId = freezed,Object? pTitle = null,Object? pContent = null,Object? pWriter = null,Object? pCreatedAt = null,Object? emojis = freezed,Object? view = freezed,Object? comments = freezed,}) {
...
as DateTime,emojis: freezed == emojis ? _self.emojis : emojis // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? pId,  String pTitle,  String pContent,  String pWriter,  DateTime pCreatedAt,  List<String>? emojis,  int? view,  List<CommentEntity>? comments)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PostEntity() when $default != null:
return $default(_that.pId,_that.pTitle,_that.pContent,_that.pWriter,_that.pCreatedAt,_that.emojis,_that.view,_that.comments);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? pId,  String pTitle,  String pContent,  String pWriter,  DateTime pCreatedAt,  List<String>? emojis,  int? view,  List<CommentEntity>? comments)  $default,) {final _that = this;
switch (_that) {
case _PostEntity():
return $default(_that.pId,_that.pTitle,_that.pContent,_that.pWriter,_that.pCreatedAt,_that.emojis,_that.view,_that.comments);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? pId,  String pTitle,  String pContent,  String pWriter,  DateTime pCreatedAt,  List<String>? emojis,  int? view,  List<CommentEntity>? comments)?  $default,) {final _that = this;
switch (_that) {
case _PostEntity() when $default != null:
return $default(_that.pId,_that.pTitle,_that.pContent,_that.pWriter,_that.pCreatedAt,_that.emojis,_that.view,_that.comments);case _:
  return null;
...
class _PostEntity implements PostEntity {
  const _PostEntity({this.pId, required this.pTitle, required this.pContent, required this.pWriter, required this.pCreatedAt, final  List<String>? emojis, this.view, final  List<CommentEntity>? comments}): _emojis = emojis,_comments = comments;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PostEntity&&(identical(other.pId, pId) || other.pId == pId)&&(identical(other.pTitle, pTitle) || other.pTitle == pTitle)&&(identical(other.pContent, pContent) || other.pContent == pContent)&&(identical(other.pWriter, pWriter) || other.pWriter == pWriter)&&(identical(other.pCreatedAt, pCreatedAt) || other.pCreatedAt == pCreatedAt)&&const DeepCollectionEquality().equals(other._emojis, _emojis)&&(identical(other.view, view) || other.view == view)&&const DeepCollectionEquality().equals(other._comments, _comments));
}


@override
int get hashCode => Object.hash(runtimeType,pId,pTitle,pContent,pWriter,pCreatedAt,const DeepCollectionEquality().hash(_emojis),view,const DeepCollectionEquality().hash(_comments));
...
/// Create a copy of PostEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? pId = freezed,Object? pTitle = null,Object? pContent = null,Object? pWriter = null,Object? pCreatedAt = null,Object? emojis = freezed,Object? view = freezed,Object? comments = freezed,}) {
...
as String,pWriter: null == pWriter ? _self.pWriter : pWriter // ignore: cast_nullable_to_non_nullable
as String,pCreatedAt: null == pCreatedAt ? _self.pCreatedAt : pCreatedAt // ignore: cast_nullable_to_non_nullable
as DateTime,emojis: freezed == emojis ? _self._emojis : emojis // ignore: cast_nullable_to_non_nullable
as List<String>?,view: freezed == view ? _self.view : view // ignore: cast_nullable_to_non_nullable
