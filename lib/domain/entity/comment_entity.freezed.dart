...
mixin _$CommentEntity {
 ...
 String? get cId; String get cContent; String get cWriter; DateTime get cCreatedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CommentEntity&&(identical(other.cId, cId) || other.cId == cId)&&(identical(other.cContent, cContent) || other.cContent == cContent)&&(identical(other.cWriter, cWriter) || other.cWriter == cWriter)&&(identical(other.cCreatedAt, cCreatedAt) || other.cCreatedAt == cCreatedAt));
}


@override
int get hashCode => Object.hash(runtimeType,cId,cContent,cWriter,cCreatedAt);

@override
String toString() {
  return 'CommentEntity(cId: $cId, cContent: $cContent, cWriter: $cWriter, cCreatedAt: $cCreatedAt)';
}
...
@useResult
$Res call({
 String? cId, String cContent, String cWriter, DateTime cCreatedAt
});
...
/// Create a copy of CommentEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? cId = freezed,Object? cContent = null,Object? cWriter = null,Object? cCreatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? cId,  String cContent,  String cWriter,  DateTime cCreatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CommentEntity() when $default != null:
return $default(_that.cId,_that.cContent,_that.cWriter,_that.cCreatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? cId,  String cContent,  String cWriter,  DateTime cCreatedAt)  $default,) {final _that = this;
switch (_that) {
case _CommentEntity():
return $default(_that.cId,_that.cContent,_that.cWriter,_that.cCreatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? cId,  String cContent,  String cWriter,  DateTime cCreatedAt)?  $default,) {final _that = this;
switch (_that) {
case _CommentEntity() when $default != null:
return $default(_that.cId,_that.cContent,_that.cWriter,_that.cCreatedAt);case _:
  return null;
...
class _CommentEntity implements CommentEntity {
  const _CommentEntity({this.cId, required this.cContent, required this.cWriter, required this.cCreatedAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CommentEntity&&(identical(other.cId, cId) || other.cId == cId)&&(identical(other.cContent, cContent) || other.cContent == cContent)&&(identical(other.cWriter, cWriter) || other.cWriter == cWriter)&&(identical(other.cCreatedAt, cCreatedAt) || other.cCreatedAt == cCreatedAt));
}
...
/// Create a copy of CommentEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? cId = freezed,Object? cContent = null,Object? cWriter = null,Object? cCreatedAt = null,}) {
