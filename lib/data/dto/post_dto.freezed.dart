...
@override
String toString() {
  return 'PostDto(pId: $pId, uId: $uId, pTitle: $pTitle, pContent: $pContent, pWriter: $pWriter, pCreatedAt: $pCreatedAt, pImageUrl: $pImageUrl, emojis: $emojis, uIdForView: $uIdForView)';
}
...
@override@JsonKey(name: "u_id_for_view") Set<String>? get uIdForView {
