...
class MealRemoteDataSourceImpl implements MealRemoteDataSource {
  ...
  Future<List<NeisMealDTO>> getMeals({
    ...
    try {
      final fromDate = DateFormat('yyyyMMdd').format(from); // NEIS API 날짜 형식
      final toDate = DateFormat('yyyyMMdd').format(to);
      final response = await dio
          .get(
            ...
            queryParameters: {
              ...
              'MLSV_FROM_YMD': fromDate, // 시작일
              'MLSV_TO_YMD': toDate, // 종료일
            },
          )
      ...
      if (response.statusCode == 200) {
        ...
        if (data['mealServiceDietInfo'] != null) {
          ...
          final row = (rowField as Map<String, dynamic>)['row'] as List; // []안에 {}있는 구조
